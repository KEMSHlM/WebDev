...
#define H8_3069F_SCI_SSR_FERERS     (1<<4) /* 受信有効 */
#define H8_3069F_SCI_SSR_ORER       (1<<5) /* 送信有効 */
#define H8_3069F_SCI_SSR_RDRF       (1<<6) /* 受信割り込み有効 */
#define H8_3069F_SCI_SSR_TDRE       (1<<7) /* 送信割り込み有効 */
...
{
    volatile struct h8_3068f_sci *sci = regs[index].sci;
